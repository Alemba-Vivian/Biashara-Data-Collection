...
import { TermsAndConditionsComponent } from './terms-and-conditions/terms-and-conditions.component'; // Import your terms-and-conditions component
  ...
  },
  {
    ...
    children: [
      ...
      // },
      {
        path: 'submissions',
        loadChildren:
        () => import('./submissions/config/main.module').then(m => m.MainModule),
        canActivate: [AuthenticationGuard, ChangePasswordGuard],
      },
      // {
      //   path: 'reports',
